...
<link rel="stylesheet" href="assets/demo.css">
  ...
  <form name="form1" method="post" action="proses_user.php">
  <table class="table table-bordered" border="4" align="center">
  
 
  <tr>
  <td>Nama</td>
  <td><input class="form-control" style="width:300px;  margin-left:10px; margin-top:10px;   "  placeholder="Nama" name="nama" type="text" required/></td>
 </tr> 
  <tr>
  <td>Username</td>
<td><input class="form-control" style="width:300px;  margin-left:10px; margin-top:10px;   "  placeholder="Username" name="username" type="text" required/></td>
 </tr>
  <tr>
  <td>Password</td>
 <td><input class="form-control" style="width:300px;  margin-left:10px; margin-top:10px;   "  placeholder="Password" name="password" type="password" required/></td>
 </tr>
 <tr>
      <td><label  style="margin-top:10px;" ><b> Level </label></td>
      <td><select class="form-control" style="width:auto; margin-top:10px;  margin-left:10px; " name="level" required>
        <option align="center" value="" required>---Pilih---</option> 
        <option value="1" required>Loket</option>
