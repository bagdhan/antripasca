...
?>
  <div class="panel-heading">
   <div class="panel-title">Tambah Pengajuan</div>
    <div class="panel-body">
     <form name="form1" method="post" action="tambah_pengajuan1.php">
  ...
  <td> <input class="form-control" style="width:300px;   margin-top:10px;" name="nama" type="text" value="<?php echo $buff['nama']; ?>"  readonly/></td></td>
   ...
   <tr>
         ...
         <td><select  name="id_pengajuan" class="myselect" class="form-control" style="width:300px;  margin-left:20px; " required>
   <option value="">Masukan Jenis Pengajuan</option>
            <?php
            include ('config.php');
        $sq = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pengajuan ORDER BY nama_surat");
        while($p=mysqli_fetch_array($sq)){
        echo "<option value=\"$p[id_pengajuan]\">".$p['nama_surat']."//".$p['waktu']." Hari</option>\n";
        }
      ?>
  </select>
...
<script type="text/javascript">
  ...
  <td><input class="form-control" style="width:300px;   margin-top:10px;   " name="tanggal_pengajuan" type="text" value="<?php echo $buff['tanggal_pengajuan']; ?>" readonly /></td>
  </tr>
  <tr>
  <td>Estimasi Selesai</td>
  <td><input class="form-control" style="width:300px;   margin-top:10px;   " name="estimasi" type="date" value="<?php echo $buff['estimasi']; ?>" required/></td>
  </tr>
  <tr>
  <td ><input class="btn btn-primary signup" type="submit" name="submit" value="Simpan" /></td>
   <td ><a href="tahap3.php?id_proses=<?php echo  $id ; ?>" class="btn btn-primary">Batal</a></td></tr>
  </table></form>
