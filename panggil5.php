                ...
                <div class="container">
                    ...
                    <!--<div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1>SEKOLAH PASCASARJANA<BR><strong>INSTITUT PERTANIAN BOGOR</strong></h1>
                        ...
                        <div class="col-sm-7">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <img src="assets/img/backgrounds/th.jpg">
					...
					<script type="text/javascript" src="tampil.js"></script>
		                	...
		                	<div class="social-login">
	                            ...
	                            <div class="form-bottom">
				                    <img src="assets/img/backgrounds/td.jpg">
									<marquee scrolldelay="200" direction="up" ><?php
include"config.php";
                       $query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM antrian a1 left join mahasiswa a2 ON a1.nrp=a2.nrp order by id");
...
?>
	                            <div class="form-bottom">
				                    <marquee scrolldelay="200" direction="up" ><p  align="left" margin-left="20px"> <font  style="font-size:20px; "  ><?php echo $buff['info']; ?></p></marquee>
			                    </div>
                        	</div>
