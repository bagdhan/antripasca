...
<td  align="center" width="200"colspan="2"> <font  style="font-size:10px ;"><b>LEMBAR PELAYANAN ADMINISTRASI AKADEMIK
<br>
No.Reg :  <?php echo $buff['id_proses']; ?></td>
<tr>
<td width="0"colspan="2"> <font  style="font-size:11px ;"><b> Nama &nbsp &nbsp &nbsp: <?php echo $buff['nama']; ?> <br><font  style="font-size:10px ;">NRP  &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp: <?php echo $buff['nrp']; ?> &nbsp&nbsp&nbsp&nbsp &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Mayor &nbsp&nbsp&nbsp : <?php echo $buff['prodi']; ?>
  <br><font  style="font-size:10px ;">Program  &nbsp:  <?php echo $buff['mayor']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Status SPP&nbsp :</td></tr>
<tr>
...
echo $view_date; 
 ?> <br><font  style="font-size:11px ;"> Tgl Penyelesaian :  <?php $db_date = $buff['estimasi'];
...
<tr>
<td width="0" colspan="2"><font  style="font-size:11px ;"><b>Nama &nbsp: <?php echo $buff['nama']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Mayor &nbsp&nbsp&nbsp : <?php echo $buff['prodi']; ?>

  <br> <font  style="font-size:11px ;">NRP &nbsp&nbsp&nbsp: <?php echo $buff['nrp']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Program : <?php echo $buff['mayor']; ?> 
<tr>
<td width="30" colspan="2"><font  style="font-size:11px ;"><b> Jenis Pengajuan : <?php echo $buff['nama_surat']; ?> </td></tr>
<tr>
<td width="30" align="center" colspan="2"><font  style="font-size:14px ;"><b>Paraf & Tanggal Proses </td></tr>
<tr>
<td width="30" style="margin-top:10;"><font  style="font-size:11px ;">Staf Pasca</td>
<td width="130"> </td>
<tr>
<td width="30"><font  style="font-size:11px ;">Kasubag/KTU</td>
<td width="130"> </td>
<tr>
<td width="30"><font  style="font-size:11px ;">Sekprog S2/S3</td>
<td width="130"> </td>
<tr>
<td width="30"><font  style="font-size:11px ;">Dekan/Wadek</td>
<td width="130"> </td>
<tr>
<td width="30"><font  style="font-size:11px ;">Persuratan</td>
<td width="130"> </td>
<tr>
<td width="30" colspan="2"><font  style="font-size:11px ;"><b>Tgl Pengajuan &nbsp&nbsp&nbsp&nbsp:  <?php $db_date = $buff['tanggal_pengajuan'];
$view_date = date("d-F-Y", strtotime($db_date));
...
<tr>
<td width="30" colspan="2"><font  style="font-size:11px ;"><b>Pelayanan :  <?php echo $buff['nama_user']; ?> </td>
</tr>
</table>
<br>
<br>
